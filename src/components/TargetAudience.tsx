...
const AUDIENCE_DATA = [
  {
    ...
    items: [
      'Visibilidade real da execução feita por parceiros',
      'Dados confiáveis para cobrança e auditoria',
      'Monitoramento de problemas em tempo real',
      'Histórico completo para compliance e decisões',
    ],
  },
  {
    type: 'agency',
    title: 'Agências e Prestadores',
    icon: <Briefcase className="h-8 w-8" />,
    items: [
      'Comprove a execução do seu time em campo',
      'Aumente a confiança do cliente com evidências',
      'Dados organizados e fáceis de compartilhar',
      'Menos questionamentos sobre o que foi feito',
    ],
  },
]
